...
with col_table:
    st.dataframe(
        ...
        column_config={
            ...
            "Avg Breakeven": st.column_config.NumberColumn(format="dollar"),
...
for asset_class, group in df.groupby("asset_class", sort=True):
    ...
    st.dataframe(
        ...
        use_container_width=True,
        column_config={
            "cost_value": st.column_config.NumberColumn("Cost Value", format="dollar"),
            ...
            "market_price": st.column_config.NumberColumn("Market Price", format="dollar"),
