...
if not symbol_stats.empty:
    ...
    st.dataframe(
        ...
        column_config={
            ...
            "avg_pnl": st.column_config.NumberColumn("Avg P&L", format="dollar"),
            "total_commission": st.column_config.NumberColumn("Commissions", format="dollar"),
        },
    )
...
if not _pos_rows:
    ...
    st.dataframe(
        ...
        column_config={
            ...
            "breakeven": st.column_config.NumberColumn("Avg Breakeven", format="dollar"),
            "market_value": st.column_config.NumberColumn("Market Value", format="dollar"),
            "unrealized_pnl": st.column_config.NumberColumn("Unrealized P&L", format="dollar"),
            "positions": "Positions",
        },
    )
...
st.dataframe(
    ...
    column_config={
        ...
        "proceeds": st.column_config.NumberColumn(format="dollar"),
        "commission": st.column_config.NumberColumn(format="dollar"),
        "realized_pnl": st.column_config.NumberColumn("Realized P&L", format="dollar"),
